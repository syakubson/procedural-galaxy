  ...
  return [
    ...
    makeSpecialSystem({
      ...
      flagshipOverride: {
        name: 'Идущий лес',
        lore: [
          '«Идущий лес» — выращенный левиафан флагманской роли: четыреста метров живого хитина, рощи мшистых гребней и медленный зелёный свет вдоль борта. Экипажа у него нет — корабль живёт сам.',
